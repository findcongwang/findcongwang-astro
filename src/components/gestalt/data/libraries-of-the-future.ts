...
export const librariesOfTheFutureData: DualTrackPresentation = {
  ...
  // ─── STORY TRACK (placeholder) ────────────────────────────────────
  story: {
    type: "steps",
    visualisation: "wordcloud",
    steps: [
      { id: "story-placeholder", label: "Story track to be designed", conceptsAdded: ["Libraries of the Future"] },
    ],
    threadColors: {
      "problem": "#ef4444",
      "architecture": "#0ea5e9",
  ...
  anchors: [
    { slideId: "slide-title", storyStepId: "story-placeholder" },
  ],
};
