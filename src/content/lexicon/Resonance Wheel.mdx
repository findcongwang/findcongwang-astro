...
description: A chord-diagram-based visualisation methodology for revealing interdependencies between dimensions of multi-dimensional indices. Companion to radar charts, correcting the reductionist illusion that dimensions of complex systems can be treated as independent variables.
formats: ["print"]
...
A <FootNote n={2} color="burgundy" note="Chord diagram: a circular visualisation where sectors represent categories and arcs (chords) connect sectors to show relationships between them. In the Resonance Wheel, major categories occupy sectors of the circle, sub-dimensions branch inward as hierarchical leaves within each sector, and connection chords arc between sectors to show resonance strength.">chord diagram structure</FootNote> rendered in radial layout. Major categories occupy sectors of the circle (matching the radar chart's polar organisation). Sub-dimensions branch inward as hierarchical leaves within each sector. Connection chords arc between sectors, encoded by weight (line thickness or colour intensity) to indicate resonance strength.
...
<MarginNote n={2} label="CVI Resonance Example" color="blue" note="In the Cognitive Vitality Index, the six input dimensions (Agency Retention, Critical Thinking Maintenance, Skill Preservation, Engagement Distribution, Resilience Under Absence, Enabling Conditions) plus the capstone output dimension (Synthesis Quality) exhibit strong resonance patterns that make isolated intervention unreliable.">The CVI provides the clearest demonstration of why the Resonance Wheel is necessary.</MarginNote> Consider three interaction patterns:
...
**Enabling Conditions and Synthesis Quality (dampening resonance):** If verification and monitoring of AI outputs (now a component of Enabling Conditions) consumes excessive cognitive load, less capacity remains for genuine synthesis. Organisations that increase AI oversight requirements may inadvertently reduce the creative synthesis they intended to protect.

**Skill Preservation, Agency Retention, and Critical Thinking (cascade resonance):** Loss of domain-specific skill undermines confidence in one's own judgment, reducing perceived agency (why override the AI if you no longer trust your own expertise?). Reduced agency decreases the likelihood of practising critical thinking. This further reduces practice frequency, accelerating skill loss. A three-hop cascade from a single point of erosion.
...
|-------|-----------|-------------------|
| **Cognitive Vitality Index** | Agency Retention, Critical Thinking, Skill Preservation, Engagement Distribution, Resilience Under Absence, Enabling Conditions | Skill atrophy cascades to reduced agency and critical thinking |
...
| **[Resonance Wheel of Life](/lexicon/resonance-wheel-of-life)** | Physical Vitality, Cognitive Capital, Perceived Abundance, Relational Resonance, Existential Direction | Functional Health fuels Cognitive Capital; Professional Execution taxes Unstructured Recreation |
...
<RoughAnnotation type="highlight" color="green">The Resonance Wheel combines the relational clarity of a chord diagram with hierarchical decomposition within each sector, rendered in a form that pairs naturally with the most common multi-dimensional snapshot visualisation.</RoughAnnotation>
