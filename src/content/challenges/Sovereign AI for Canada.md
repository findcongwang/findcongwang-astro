...
1. **Order-of-magnitude domestic compute expansion:** Increase Canadian AI supercomputing capacity from 0.6 per cent to competitive global position

2. **Clean energy coupling:** New infrastructure must be coupled with renewable generation—hydroelectric, solar, wind, or geothermal

3. **Economic retention mechanism:** Create value proposition compelling enough that AI professionals and startups choose to remain and grow in Canada

4. **Data sovereignty by design:** Ensure Canadian data can be processed entirely within Canadian jurisdiction

5. **Geographic advantage exploitation:** Leverage cold climate for energy-efficient cooling (40–60 per cent reduction in cooling energy in northern winters)

6. **Climate adaptive infrastructure:** Design systems capable of supporting future population shifts northward as habitable zones migrate
...
1. **Compute-as-a-Service:** Domestic AI companies lease compute capacity
2. **Canada-specific Cloud Services:** Sovereign cloud for government, healthcare, finance
3. **Green AI Credits:** Exportable certificate for carbon-efficient AI training
4. **Energy Arbitrage:** Use low-cost off-peak power for compute, sell peak demand back to grid
...
- [How Might We Design a Digital Sovereignty Economy?](/research/questions/digital-sovereignty) — Parent CQ
- [Digital Sovereignty and Work Twins](/lexicon/digital-sovereignty-and-work-twins) — Sovereign ownership framework
- [Hybrid Intelligence](/lexicon/hybrid-intelligence) — Organisational model requiring compute
- [Build-to-Manage](/lexicon/build-to-manage) — Revenue model for infrastructure
- [Innovation Sovereignty](/lexicon/innovation-sovereignty) — National innovation self-determination
